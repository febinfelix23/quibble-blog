  ...
  return (
    <Navbar className='border-b-2 p-3'>
      ...
      <div className="flex gap-2 md:order-2">
        <Button className='w-12 h-10 hidden sm:inline me-5' color='gray' pill>
          <FaMoon />
        </Button>
          ...
          currentUser? (
            <Dropdown arrowIcon={false} inline label={<Avatar alt='user' img={currentUser.profilePicture} rounded/>}>
              <Dropdown.Header>
                ...
                <span className='block text-sm' truncate><span className='font-semibold'>email: </span>{currentUser.email}</span>
              </Dropdown.Header>
