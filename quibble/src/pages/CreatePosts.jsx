...
function CreatePosts() {
    ...
    // Upload Complete Post function and API
    const handleUploadPost = async (e) => {
        e.preventDefault();
        try {
            const result = await fetch('/qserver/post/create', {
                method: 'POST',
            ...
            if(result.ok){
                ...
                navigate(`/post/${resultData.slug}`)
            }else{
                setPublishError(resultData.message);
                return;
            }
        } catch (error) {
    ...
    return (
        <div className='p-3 max-w-3xl mx-auto min-h-screen'>
            ...
            <form className='flex flex-col gap-4' onSubmit={handleUploadPost}>
